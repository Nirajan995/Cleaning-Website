                     ...
                     <div className="w-full flex flex-col items-start  xl:justify-start  relative xl:px-0 px-4 xl:py-0 py-4">
                        <div className="w-full 2xl:pl-48 xl:pt-1">
                           ...
                           <div className="w-full md:w-10/12 mt-3">
                              <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider">Nothing Inspires Cleanliness More Than An Unexpected Guest.</h2>
                              <div className="mt-4 md:mt-8">
                                 <h2 className="text-sm md:text-base text-indigo-700 font-semibold">Address</h2>
                                 <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">Office #13, NSTP, NUST University H-12 Sector, Australia</h2>
                              </div>
                              <div className="mt-4 md:mt-8">
                        ...
                        <div className="w-full 2xl:w-8/12 mt-3">
                           ...
                           <form ref={form} onSubmit={sendEmail}>
                              ...
                              <div className="mt-4 md:mt-8">
                                 ...
                                 <input name="user_email" className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black py-5 pl-4 text-gray-800" type="email" placeholder="example@mail.com" />
                              </div>
                              <div className="mt-4 md:mt-8">
                                 <p className="text-gray-800 text-base font-medium">Phone Number</p>
                                 <input name="contact_number" className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black py-5 pl-4 text-gray-800" type="number" placeholder="+92 051 4567890" />
                              </div>
                              <div className="mt-4 md:mt-8">
                                 <p className="text-gray-800 text-base font-medium">Message</p>
                                 <textarea name="message" className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black xl:h-40 py-5 pl-4 text-gray-800" type="text" placeholder="Write us something..." defaultValue={""} />
                              </div>
                              <div className="py-5">
